...
export function CategoriasView() {
  const { categorias, isLoading, handleDelete, refresh } = useCategoriasViewModel();
    ...
    <AdminLayout title="Categorías">
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button className="px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-xl font-medium transition-colors shadow-sm shadow-teal-500/30 flex items-center gap-2">
            <Plus size={18} />
            Nueva Categoría
          </button>
        </div>
